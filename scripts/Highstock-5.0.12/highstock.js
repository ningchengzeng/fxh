    ...
    L = function() {
        ...
        a.Fx.prototype = {
            dSetter: function() {
                ...
                t;
                if (1 === r) u = this.toD;
                else if (x === h.length && 1 > r) for (; x--;) t = parseFloat(a[x]),
            ...
            step: function(n) {
                ...
                m = r.duration,
                f = r.curAnim;
                x.attr && !x.element ? n = !1 : n || h >= m + this.startTime ? (this.now = this.end, this.pos = 1, this.update(), u = f[this.prop] = !0, a.objectEach(f,
                function(a) { ! 0 !== a && (u = !1)
            ...
            initPath: function(n, h, u) {
                function r(a) {
                    var c, b;
                    for (A = a.length; A--;) c = "M" === a[A] || "L" === a[A],
                    b = /[a-zA-Z]/.test(a[A + 3]),
                    c && b && a.splice(A + 1, 0, a[A + 1], a[A + 2], a[A + 1], a[A + 2])
                }
                function x(a, c) {
                    for (; a.length < p;) {
                        a[0] = c[p - a.length];
                ...
                function t(a, c) {
                    for (var q = (p - a.length) / d; 0 < q && q--;) b = a.slice().splice(a.length / H - d, d * H),
                    b[0] = c[p - d - q * d],
                ...
                e && (r(h), r(u));
                if (f && g) {
                    for (A = 0; A < f.length; A++) if (f[A] === g[0]) {
                        m = A;
                        break
        ...
        a.merge = function() {
            ...
            x = function(h, m) {
                "object" !== typeof h && (h = {});
                a.objectEach(m,
                function(f, g) { ! a.isObject(f, !0) || a.isClass(f) || a.isDOMElement(f) ? h[g] = m[g] : h[g] = x(h[g] || {},
                    f)
                });
                return h
        ...
        a.attr = function(n, h, u) {
            var r;
            a.isString(h) ? a.defined(u) ? n.setAttribute(h, u) : n && n.getAttribute && (r = n.getAttribute(h)) : a.defined(h) && a.isObject(h) && a.objectEach(h,
            function(a, h) {
                n.setAttribute(h, a)
            });
            return r
        ...
        a.pick = function() {
            var a = arguments,
            h, u, r = a.length;
            for (h = 0; h < r; h++) if (u = a[h], void 0 !== u && null !== u) return u
        };
        a.css = function(n, h) {
        ...
        a.normalizeTickInterval = function(n, h, u, r, x) {
            ...
            u = a.pick(u, 1);
            t = n / u;
            h || (h = x ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10], !1 === r && (1 === u ? h = a.grep(h,
            function(a) {
                return 0 === a % 1
            }) : .1 >= u && (h = [1 / u])));
        ...
        a.numberFormat = function(n, h, u, r) {
            ...
            m,
            f; - 1 === h ? h = Math.min(t, 20) : a.isNumber(h) || (h = 2);
        ...
        a.getStyle = function(n, h, u) {
            if ("width" === h) return Math.min(n.offsetWidth, n.scrollWidth) - a.getStyle(n, "padding-left") - a.getStyle(n, "padding-right");
            if ("height" === h) return Math.min(n.offsetHeight, n.scrollHeight) - a.getStyle(n, "padding-top") - a.getStyle(n, "padding-bottom");
            if (n = D.getComputedStyle(n, void 0)) n = n.getPropertyValue(h),
            a.pick(u, !0) && (n = a.pInt(n));
            return n
        };
        ...
        a.fireEvent = function(n, h, u, r) {
            ...
            var t, m;
            u = u || {};
            if (F.createEvent && (n.dispatchEvent || n.fireEvent)) x = F.createEvent("Events"),
            x.initEvent(h, !0, !0),
            a.extend(x, u),
            n.dispatchEvent ? n.dispatchEvent(x) : n.fireEvent(h, x);
            else if (x) for (x = x[h] || [], t = x.length, u.target || a.extend(u, {
        ...
        a.animate = function(n, h, u) {
            ...
            function(f, e) {
                ...
                m = new a.Fx(n, u, e);
                t = null;
                "d" === e ? (m.paths = m.initPath(n, n.d, h.d), m.toD = h.d, r = 0, t = 1) : n.attr ? r = n.attr(e) : (r = parseFloat(a.getStyle(n, e)) || 0, "opacity" !== e && (x = "px"));
                t || (t = f);
        ...
        F && !F.defaultView && (a.getStyle = function(n, h) {
            ...
            "opacity" === h && (h = "filter");
            if (u) return n.style.zoom = 1,
            Math.max(n[u] - 2 * a.getStyle(n, "padding"), 0);
            n = n.currentStyle[h.replace(/\-(\w)/g,
            function(a, h) {
                return h.toUpperCase()
            })];
            "filter" === h && (n = n.replace(/alpha\(opacity=([0-9]+)\)/,
            function(a, h) {
                return h / 100
            }));
            return "" === n ? 1 : a.pInt(n)
        ...
        Array.prototype.forEach || (a.each = function(a, h, u) {
            for (var r = 0,
            n = a.length; r < n; r++) if (!1 === h.call(u, a[r], r, a)) return r
        });
        ...
        a.Color.prototype = {
            ...
            init: function(h) {
                var n, r, x, t;
                if ((this.input = h = this.names[h && h.toLowerCase ? h.toLowerCase() : ""] || h) && h.stops) this.stops = F(h.stops,
                function(m) {
                    return new a.Color(m[1])
                });
                else if (h && "#" === h[0] && (n = h.length, h = parseInt(h.substr(1), 16), 7 === n ? r = [(h & 16711680) >> 16, (h & 65280) >> 8, h & 255, 1] : 4 === n && (r = [(h & 3840) >> 4 | (h & 3840) >> 8, (h & 240) >> 4 | h & 240, (h & 15) << 4 | h & 15, 1])), !r) for (x = this.parsers.length; x--&&!r;) t = this.parsers[x],
                (n = t.regex.exec(h)) && (r = t.parse(n));
                this.rgba = r || []
            },
            get: function(a) {
                var h = this.input,
                r = this.rgba,
                n;
                this.stops ? (n = D(h), n.stops = [].concat(n.stops), E(this.stops,
                function(h, m) {
            ...
            brighten: function(a) {
                ...
                else if (B(a) && 0 !== a) for (h = 0; 3 > h; h++) r[h] += n(255 * a),
                0 > r[h] && (r[h] = 0),
                255 < r[h] && (r[h] = 255);
                return this
            },
        ...
        d(E.prototype, {
            ...
            colorGradient: function(C, k, c) {
                ...
                d && (q = C[d], w = z.gradients, g = C.stops, R = c.radialReference, H(q) && (C[d] = q = {
                    x1: q[0],
                    y1: q[1],
                    x2: q[2],
                    y2: q[3],
                ...
                function(a) {
                    p.push(a)
                }), p = p.join(","), w[p] ? R = w[p].attr("id") : (q.id = R = a.uniqueKey(), w[p] = G = z.createElement(d).attr(q).add(z.defs), G.radAttr = f, G.stops = [], e(g,
                function(C) {
            ...
            applyTextOutline: function(C) {
                ...
                if ((l = C[0]) && "none" !== l && a.svg) {
                    ...
                    for (d = C.length; d--;) c = C[d],
                    "highcharts-text-outline" === c.getAttribute("class") && p(C, k.removeChild(c));
                    b = k.firstChild;
                    e(C,
                    function(a, C) {
            ...
            attr: function(a, k, c, z) {
                ...
                d, q = this,
                e, y;
                "string" === typeof a && void 0 !== k && (C = a, a = {},
                a[C] = k);
                "string" === typeof a ? q = (this[a + "Getter"] || this._defaultGetter).call(this, a, b) : (l(a,
                function(k, C) {
                    e = !1;
                    z || Q(this, C);
            ...
            updateShadows: function(a, k, c) {
                ...
                z = C.length; z--;) c.call(C[z], "height" === a ? Math.max(k - (C[z].cutHeight || 0), 0) : "d" === a ? this.d: k, a, C[z])
            },
            ...
            symbolAttr: function(a) {
                var k = this;
                e("x y r start end width height innerR anchorX anchorY".split(" "),
                function(C) {
                    k[C] = I(a[C], k[C])
                });
                k.attr({
            ...
            css: function(a) {
                ...
                y && (C && (a = d(C, c)), b = this.textWidth = a && a.width && "auto" !== a.width && "text" === z.nodeName.toLowerCase() && k(a.width), this.styles = a, b && !M && this.renderer.forExport && delete a.width, J && !M ? r(this.element, a) : (e = function(a, k) {
                    return "-" + k.toLowerCase()
                },
                l(a,
                function(a, k) { - 1 === v(k, f) && (q += k.replace(/([A-Z])/g, e) + ":" + a + ";")
            ...
            on: function(a, k) {
                ...
                c.onclick = function(a) { ( - 1 === O.navigator.userAgent.indexOf("Android") || 1100 < Date.now() - (C.touchEventFired || 0)) && k.call(c, a)
                }) : c["on" + a] = k;
                return this
            },
            ...
            updateTransform: function() {
                ...
                a = ["translate(" + a + "," + k + ")"];
                l ? a.push("rotate(90) scale(-1,1)") : b && a.push("rotate(" + b + " " + (d.getAttribute("x") || 0) + " " + (d.getAttribute("y") || 0) + ")"); (t(c) || t(z)) && a.push("scale(" + I(c, 1) + " " + I(z, 1) + ")");
            ...
            align: function(a, k, c) {
                ...
                var q, e;
                if (a) {
                    if (this.alignOptions = a, this.alignByTranslate = k, !c || w(c)) this.alignTo = C = c || "renderer",
                    p(l, this),
                    l.push(this),
                    c = null
            ...
            getBBox: function(a, k) {
                ...
                if (!C) {
                    if (l.namespaceURI === this.SVG_NS || c.forExport) {
                        try { (f = this.fakeTS &&
                            function(a) {
                                e(l.querySelectorAll(".highcharts-text-outline"),
                                function(k) {
                                    k.style.display = a
                                })
                            }) && f("none"),
            ...
            destroy: function() {
                ...
                Q(a);
                a.clipPath && z && (e(z.querySelectorAll("[clip-path]"),
                function(k) { - 1 < k.getAttribute("clip-path").indexOf(a.clipPath.element.id + ")") && k.removeAttribute("clip-path")
                ...
                a.safeRemoveChild(k);
                for (a.destroyShadows(); c && c.div && 0 === c.div.childNodes.length;) k = c.parentGroup,
            ...
            shadow: function(a, k, c) {
                ...
                if (!a) this.destroyShadows();
                    ...
                    c && (n(l, "height", Math.max(n(l, "height") - d, 0)), l.cutHeight = d),
            ...
            zIndexSetter: function(a, c) {
                ...
                if (b) { (a = this.zIndex) && l && (l.handleZ = !0);
                    c = C.childNodes;
                    for (e = 0; e < c.length && !q; e++) l = c[e],
                    b = l.zIndex,
                    l !== d && (k(b) > a || !t(a) && t(b) || 0 > a && !t(b) && C !== z.box) && (C.insertBefore(d, l), q = !0);
                    q || C.appendChild(d)
                }
                return q
            },
        ...
        E.prototype["stroke-widthSetter"] = E.prototype.strokeSetter = function(a, k, c) {
            this[k] = a;
            this.stroke && this["stroke-width"] ? (E.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0) : "stroke-width" === k && 0 === a && this.hasStroke && (c.removeAttribute("stroke"), this.hasStroke = !1)
        };
        ...
        d(B.prototype, {
            ...
            init: function(a, k, c, z, l, b) {
                ...
                this.boxWrapper = z;
                this.alignedObjects = [];
                this.url = (q || K) && g.getElementsByTagName("base").length ? O.location.href.replace(/#.*?$/, "").replace(/<[^>]*>/g, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
            ...
            buildText: function(a) {
                ...
                if (Q !== a.textCache) {
                    ...
                    q || A || H || J || -1 !== d.indexOf(" ") ? (y = /<.*class="([^"]+)".*>/, f = /<.*style="([^"]+)".*>/, w = /<.*href="([^"]+)".*>/, p && p.appendChild(c), d = q ? d.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [d], d = b(d,
                    function(a) {
                        return "" !== a
                    }), e(d,
                    function(k, b) {
                        ...
                        function(k) {
                            if ("" !== k || 1 === d.length) {
                                ...
                                f.test(k) && (I = k.match(f)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), n(e, "style", I));
                                ...
                                if (" " !== k) {
                                    ...
                                    if (J) {
                                        ...
                                        h = u(e),
                                        Q = a.rotation;
                                        for (H && (G = z.applyEllipsis(a, e, k, J)); ! H && p && (C.length || m.length);) a.rotation = 0,
                                        A = z.getSpanWidth(a, e),
                                        k = A > J,
                                        void 0 === G && (G = k),
                                        k && 1 !== C.length ? (e.removeChild(e.firstChild), m.unshift(C.pop())) : (C = m, m = [], C.length && !K && (e = g.createElementNS(N, "tspan"), n(e, {
                                            dy: h,
                                            x: v
                                        }), I && n(e, "style", I), c.appendChild(e)), A > J && (J = A)),
                                        C.length && e.appendChild(g.createTextNode(C.join(" ").replace(/- /g, "-")));
                                        a.rotation = Q
                                    }
                                    q++
                                }
            ...
            button: function(a, k, c, z, l, b, q, e, f) {
                ...
                v = e.style;
                delete e.style;
                F(C.element, J ? "mouseover": "mouseenter",
                function() {
                    3 !== w && C.setState(1)
                });
                F(C.element, J ? "mouseout": "mouseleave",
                function() {
                    3 !== w && C.setState(w)
                });
            ...
            symbols: {
                ...
                callout: function(a, k, c, z, l) {
                    ...
                    l = l && l.anchorY;
                    var e;
                    e = ["M", a + b, k, "L", a + c - b, k, "C", a + c, k, a + c, k, a + c, k + b, "L", a + c, k + z - b, "C", a + c, k + z, a + c, k + z, a + c - b, k + z, "L", a + b, k + z, "C", a, k + z, a, k + z, a, k + z - b, "L", a, k + b, "C", a, k, a, k, a + b, k];
            ...
            text: function(a, k, c, z) {
                ...
                z || (a.xSetter = function(a, k, c) {
                    ...
                    b = c.getAttribute(k),
                    d;
                    for (d = 0; d < z.length; d++) l = z[d],
                    l.getAttribute(k) === b && l.setAttribute(k, a);
                    c.setAttribute(k, a)
                });
                return a
            },
            ...
            label: function(k, c, l, b, q, f, w, G, g) {
                ...
                V = function() {
                    ...
                    P && (C || (p.box = C = v.symbols[b] || u ? v.symbol(b) : v.rect(), C.addClass(("button" === g ? "": "highcharts-label-box") + (g ? " highcharts-" + g + "-box": "")), C.add(p), a = R(), k.x = a, k.y = (G ? -x: 0) + a), k.width = Math.round(p.width), k.height = Math.round(p.height), C.attr(d(k, N)), N = {})
                };
                U = function() {
                    var a = A + m,
                    k;
        ...
        h(a.SVGElement.prototype, {
            ...
            setSpanRotation: function(a, d, p) {
                ...
                b[e + (u ? "Origin": "-origin")] = b.transformOrigin = 100 * d + "% " + p + "px";
                F(this.element, b)
            },
        ...
        a.svg || (B = {
            ...
            init: function(a, b) {
                ...
                d = ["position: ", "absolute", ";"],
                q = "div" === b; ("shape" === b || q) && d.push("left:0;top:0;width:1px;height:1px;");
            ...
            getSpanCorrection: function(a, b, c, d, e) {
                ...
                e && "left" !== e && (this.xCorr -= a * c * (0 > q ? -1 : 1), d && (this.yCorr -= l * c * (0 > f ? -1 : 1)), D(this.element, {
                    textAlign: e
                }))
            },
            pathToVML: function(a) {
                for (var b = a.length,
                c = []; b--;) g(a[b]) ? c[b] = Math.round(10 * a[b]) - 5 : "Z" === a[b] ? c[b] = "x": (c[b] = a[b], !a.isArc || "wa" !== a[b] && "at" !== a[b] || (c[b + 5] === c[b + 7] && (c[b + 7] += a[b + 7] > a[b + 5] ? 1 : -1), c[b + 6] === c[b + 8] && (c[b + 8] += a[b + 8] > a[b + 6] ? 1 : -1)));
                return c.join(" ") || "x"
            },
            clip: function(a) {
                var b = this,
            ...
            shadow: function(a, d, c) {
                ...
                if (a) {
                    A = p(a.width, 3);
                    J = (a.opacity || .15) / A;
                    for (q = 1; 3 >= q; q++) m = 2 * A + 1 - 2 * q,
                    c && (M = this.cutOffPath(z.value, m + .5)),
                    k = ['\x3cshape isShadow\x3d"true" strokeweight\x3d"', m, '" filled\x3d"false" path\x3d"', M, '" coordsize\x3d"10 10" style\x3d"', f.style.cssText, '" /\x3e'],
                    l = F(g.prepVML(k), null, {
                        left: b(v.left) + p(a.offsetX, 1),
                        top: b(v.top) + p(a.offsetY, 1)
                    }),
                    c && (l.cutOff = m + 1),
                    k = ['\x3cstroke color\x3d"', a.color || "#000000", '" opacity\x3d"', J * q, '"/\x3e'],
            ...
            dashstyleSetter: function(a, b, c) { (c.getElementsByTagName("stroke")[0] || F(this.renderer.prepVML(["\x3cstroke/\x3e"]), null, null, c))[b] = a || "solid";
                this[b] = a
            },
        ...
        B["stroke-opacitySetter"] = B["fill-opacitySetter"], a.VMLElement = B = E(A, B), B.prototype.ySetter = B.prototype.widthSetter = B.prototype.heightSetter = B.prototype.xSetter, B = {
            ...
            color: function(b, d, c, e) {
                ...
                if (p) {
                    ...
                    if ("fill" === c) if ("gradient" === p) c = v.x1 || v[0] || 0,
                    b = v.y1 || v[1] || 0,
                    w = v.x2 || v[2] || 0,
                    v = v.y2 || v[3] || 0,
                    h = 'angle\x3d"' + (90 - 180 * Math.atan((v - b) / (w - c)) / Math.PI) + '"',
                    n();
                    else {
                        var k = v.r,
                        t = 2 * k,
                        ...
                        D = d.radialReference,
                        S, k = function() {
                            D && (S = e.getBBox(), B += (D[0] - S.x) / S.width - .5, E += (D[1] - S.y) / S.height - .5, t *= D[2] / S.width, u *= D[2] / S.height);
        ...
        a.Tick.prototype = {
            addLabel: function() {
                ...
                d = d.info,
                A;
                a.isDatetimeAxis && d && (A = x.dateTimeLabelFormats[d.higherRanks[g] || d.unitName]);
                this.isFirst = p;
                this.isLast = b;
    ...
    var T = function(a) {
        ...
        a.extend(I.prototype, {
            ...
            init: function(a, z) {
                ...
                z = l.options.events; - 1 === b(l, a.axes) && (k ? a.axes.splice(a.xAxis.length, 0, l) : a.axes.push(l), a[l.coll].push(l));
                l.series = l.series || [];
            ...
            defaultLabelFormatter: function() {
                ...
                else if (y && 1E3 <= k) for (; y--&&void 0 === p;) b = Math.pow(d, y + 1),
                k >= b && 0 === 10 * c % b && null !== f[y] && 0 !== c && (p = a.numberFormat(c / b, -1) + f[y]);
            ...
            getSeriesExtremes: function() {
                ...
                function(k) {
                    if (k.visible || !c.options.chart.ignoreHiddenSeries) {
                        ...
                        b.length && (k = D(b), v(k) || k instanceof Date || (b = p(b,
                        function(a) {
                            return v(a)
                        }), k = D(b)), a.dataMin = Math.min(w(a.dataMin, b[0]), k), a.dataMax = Math.max(w(a.dataMax, b[0]), F(b)));
            ...
            getMinorTickPositions: function() {
                ...
                e = a.max + e,
                y = e - f;
                if (y && y / l < a.len / 3) if (a.isLog) m(this.paddedTicks,
                function(k, c, b) {
                ...
                else for (c = f + (b[0] - f) % l; c <= e && c !== d[0]; c += l) d.push(c);
            ...
            adjustForMinRange: function() {
                ...
                b = this.max,
                l, d, e, f, y, p, g, v;
                this.isXAxis && void 0 === this.minRange && !this.isLog && (r(a.min) || r(a.max) ? this.minRange = null: (m(this.series,
                function(a) {
                    p = a.xData;
                    for (f = g = a.xIncrement ? 1 : p.length - 1; 0 < f; f--) if (y = p[f] - p[f - 1], void 0 === e || y < e) e = y
                }), this.minRange = Math.min(5 * e, this.dataMax - this.dataMin)));
                b - c < this.minRange && (d = this.dataMax - this.dataMin >= this.minRange, v = this.minRange, l = (v - b + c) / 2, l = [c - l, w(a.min, c - l)], d && (l[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin), c = F(l), b = [c + v, w(a.max, c + v)], d && (b[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax), b = D(b), b - c < v && (l[0] = b - v, l[1] = w(a.min, b - v), c = F(l)));
                this.min = c;
                this.max = b
            },
            getClosest: function() {
                var a;
                this.categories ? a = 1 : m(this.series,
                function(k) {
            ...
            nameToX: function(a) {
                ...
                r(l) || (l = !1 === this.options.uniqueNames ? a.series.autoIncrement() : b(a.name, c)); - 1 === l ? k || (d = c.length) : d = l;
            ...
            setAxisTranslation: function(a) {
                ...
                a && (k.oldTransA = p);
                k.translationSlope = k.transA = p = k.options.staticScale || k.len / (c + e || 1);
            ...
            setTickInterval: function(k) {
                ...
                B = w(c.userMin, l.min);
                D = w(c.userMax, l.max);
                q ? (c.linkedParent = b[c.coll][l.linkedTo], b = c.linkedParent.getExtremes(), c.min = w(b.min, b.dataMin), c.max = w(b.max, b.dataMax), l.type !== c.linkedParent.options.type && a.error(11, 1)) : (!t && r(K) && (c.dataMin >= K ? (u = K, I = 0) : c.dataMax <= K && (x = K, G = 0)), c.min = w(B, u, c.dataMin), c.max = w(D, x, c.dataMax));
                ...
                c.adjustForMinRange(); ! (n || c.axisPointRange || c.usePercentage || q) && r(c.min) && r(c.max) && (f = c.max - c.min) && (!r(B) && I && (c.min -= f * I), !r(D) && G && (c.max += f * G));
                ...
                c.tickInterval = c.min === c.max || void 0 === c.min || void 0 === c.max ? 1 : q && !A && H === c.linkedParent.options.tickPixelInterval ? A = c.linkedParent.tickInterval: w(A, this.tickAmount ? (c.max - c.min) / Math.max(this.tickAmount - 1, 1) : void 0, n ? 1 : (c.max - c.min) * H / Math.max(c.len, H));
                p && !k && m(c.series,
                function(a) {
                ...
                k = w(l.minTickInterval, c.isDatetimeAxis && c.closestPointRange); ! A && c.tickInterval < k && (c.tickInterval = k);
            ...
            alignToOthers: function() {
                var a = {},
                c, b = this.options; ! 1 === this.chart.options.chart.alignTicks || !1 === b.alignTicks || this.isLog || m(this.chart[this.coll],
                function(k) {
                    var b = k.options,
            ...
            zoom: function(a, c) {
                ...
                if (a !== this.min || c !== this.max) this.allowZoomOutside || (r(k) && (a < d && (a = d), a > l && (a = l)), r(b) && (c < d && (c = d), c > l && (c = l))),
            ...
            tickSize: function(a) {
                ...
                if (b && k) return "inside" === c[a + "Position"] && (k = -k),
                [k, b]
            },
            ...
            unsquish: function() {
                ...
                c ? (v = !a.staggerLines && !a.step && (r(f) ? [f] : d < w(a.autoRotationLimit, 80) && a.autoRotation)) && m(v,
                function(a) {
                    var c;
                    if (a === f || a && -90 <= a && 90 >= a) p = q(Math.abs(y.h / Math.sin(x * a))),
                    c = p + Math.abs(a / 360),
                    c < g && (g = c, e = a, l = p)
                }) : a.step || (l = q(y.h));
                this.autoRotation = v;
            ...
            renderUnsquish: function() {
                ...
                m(b,
                function(a) { (a = l[a]) && a.labelLength > w && (w = a.labelLength)
                });
                ...
                !v)) for (G.textOverflow = "clip", I = b.length; ! e && I--;) if (A = b[I], y = l[A].label) y.styles && "ellipsis" === y.styles.textOverflow ? y.css({
                    textOverflow: "clip"
            ...
            getOffset: function() {
                ...
                function(c, b) {
                    a.generateTick(c, b)
                }), a.renderUnsquish(), !1 === H.reserveSpace || 0 !== p && 2 !== p && {
                    1 : "left",
                    3 : "right"
                } [p] !== a.labelAlign && "center" !== a.labelAlign || m(e,
                function(a) {
                    n = Math.max(f[a].getLabelSize(), n)
                }), a.staggerLines && (n *= a.staggerLines, a.labelOffset = n * (a.opposite ? -1 : 1))) : c(f,
                function(a, c) {
                    a.destroy();
                    delete f[c]
                });
            ...
            getLinePath: function(a) {
                ...
                b && (a *= -1);
                return c.renderer.crispLine(["M", l ? this.left: d, l ? k: this.top, "L", l ? c.chartWidth - this.right: d, l ? k: c.chartHeight - this.bottom], a)
            },
            renderLine: function() {
            ...
            renderTick: function(a, c) {
                ...
                if (!b || a >= this.min && a <= this.max) k[a] || (k[a] = new l(this, a)),
                d && k[a].isNew && k[a].render(c, !0, .1),
                k[a].render(c)
            },
            render: function() {
                var b = this,
                ...
                if (b.hasData() || p) b.minorTickInterval && !b.categories && m(b.getMinorTickPositions(),
                function(a) {
                    b.renderMinorTick(a)
                }),
                g.length && (m(g,
                function(a, c) {
                    b.renderTick(a, c)
                }), n && (0 === b.min || b.single) && (w[ - 1] || (w[ - 1] = new l(b, -1, null, !0)), w[ - 1].render( - 1))),
                H && m(g,
                function(c, l) {
                ...
                q && J && (e = b.getTitlePosition(), v(e.y) ? (q[q.isNew ? "attr": "animate"](e), q.isNew = !1) : (q.attr("y", -9999), q.isNew = !0));
            ...
            destroy: function(a) {
                ...
                m([l.ticks, l.minorTicks, l.alternateBands],
                function(a) {
                    t(a)
                });
                ...
                c(l,
                function(a, c) { - 1 === b(c, l.keepProps) && delete l[c]
                })
            },
        ...
        E.prototype.getTimeTicks = function(a, e, d, p) {
            ...
            K;
            if (n(e)) {
                q[B.hcSetMilliseconds](c >= f.second ? 0 : w * Math.floor(q.getMilliseconds() / w));
                ...
                if (c === f.week) q[B.hcSetDate](q[B.hcGetDate]() - q[B.hcGetDay]() + m(p, 1));
                H = q[B.hcGetFullYear]();
                p = q[B.hcGetMonth]();
                var y = q[B.hcGetDate](),
                G = q[B.hcGetHours]();
                if (B.hcTimezoneOffset || B.hcGetTimezoneOffset) K = (!v || !!B.hcGetTimezoneOffset) && (d - e > 4 * f.month || x(e) !== x(d)),
                q = q.getTime(),
                q = new B(q + x(q));
                v = q.getTime();
                for (e = 1; v < d;) b.push(v),
                v = c === f.year ? J(H + e * w, 0) : c === f.month ? J(H, p + e * w) : !K || c !== f.day && c !== f.week ? K && c === f.hour ? J(H, p, y, G + e * w) : v + c * w: J(H, p, y + e * w * (c === f.day ? 1 : 7)),
                e++;
                b.push(v);
                c <= f.hour && 1E4 > b.length && h(b,
                function(a) {
        ...
        E.prototype.getLogTickPositions = function(a, u, r, x) {
            ...
            e = this.getLinearTickPositions(a, u, r);
            else if (.08 <= a) for (var m = Math.floor(u), d, p, b, A, v, h = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; m < r + 1 && !v; m++) for (p = h.length, d = 0; d < p && !v; d++) b = g(f(m) * h[d]),
            ...
            a = n("auto" === a ? null: a, this._minorAutoInterval, h.tickPixelInterval / (x ? 5 : 1) * (r - u) / ((x ? m / this.tickPositions.length: m) || 1)),
            a = D(a, null, B(a)),
        ...
        a.PlotLineOrBand.prototype = {
            render: function() {
                ...
                G.zIndex = K;
                I += "-" + K; (w = m.plotLinesAndBandsGroups[I]) || (m.plotLinesAndBandsGroups[I] = w = l.g("plot-" + I).attr(G).add());
        ...
        a.extend(E.prototype, {
            ...
            removePlotBandOrLine: function(a) {
                for (var m = this.plotLinesAndBands,
                f = this.options,
                g = this.userOptions,
                e = m.length; e--;) m[e].id === a && m[e].destroy();
                h([f.plotLines || [], g.plotLines || [], f.plotBands || [], g.plotBands || []],
                function(d) {
        ...
        a.Tooltip.prototype = {
            ...
            refresh: function(a, g) {
                ...
                g = m[0];
                f = m[1]; ! v || b.series && b.series.noSharedTooltip ? v = b.getLabelConfig() : (B(b,
                function(a) {
                    a.setState("hover");
                ...
                v = e.call(v, this);
                q = b.series;
                this.distance = r(q.tooltipOptions.distance, 16); ! 1 === v ? this.hide() : (e = this.getLabel(), this.isHidden && e.attr({
                    opacity: 1
            ...
            getXDateFormat: function(a, g, e) {
                ...
                return (d ? this.getDateFormat(d, a.x, e.options.startOfWeek, g) : g.day) || g.year
            },
        ...
        a.Pointer.prototype = {
            ...
            normalize: function(a, d) {
                ...
                void 0 === e.pageX ? (b = Math.max(a.x, a.clientX - d.left), d = a.y) : (b = e.pageX - d.left, d = e.pageY - d.top);
                return x(a, {
                    chartX: Math.round(b),
                    chartY: Math.round(d)
                })
            ...
            getKDPoints: function(a, d, e) {
                ...
                function(a) {
                    ...
                    g = !d && a.directTouch;
                    a.visible && !g && f(a.options.enableMouseTracking, !0) && (c = a.searchPoint(e, !p && 0 > a.options.findNearestPointBy.indexOf("y"))) && c.series && b.push(c)
                });
                b.sort(function(a, c) {
                ...
                if (d && b[0] && !b[0].series.noSharedTooltip) for (a = b.length; a--;)(b[a].x !== b[0].x || b[a].series.noSharedTooltip) && b.splice(a, 1);
                return b
            },
            ...
            runPointActions: function(b, d) {
                ...
                if (m && (m !== e.hoverPoint || p && p.isHidden)) {
                    r(e.hoverPoints || [],
                    function(c) { - 1 === a.inArray(c, h) && c.setState()
                    });
                    r(h || [],
                    function(a) {
                        a.setState("hover")
                ...
                this.unDocMouseMove || (this.unDocMouseMove = E(u, "mousemove",
                function(c) {
            ...
            reset: function(a, d) {
                ...
                if (a) c && m && (c.refresh(m), p && (p.setState(p.state, !0), r(b.axes,
                function(a) {
            ...
            drag: function(a) {
                ...
                I && I.touch || (e < g ? e = g: e > g + y && (e = g + y), f < m ? f = m: f > m + G && (f = m + G), this.hasDragged = Math.sqrt(Math.pow(k - e, 2) + Math.pow(z - f, 2)), 10 < this.hasDragged && (l = b.isInsidePlot(k - g, z - m), b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !h && !I && (this.selectionMarker = I = b.renderer.rect(g, m, p ? 1 : y, c ? 1 : G, 0).attr({
        ...
        F(a.Pointer.prototype, {
            ...
            pinch: function(a) {
                ...
                }), g.x = [t[0].chartX, t[1] && t[1].chartX], g.y = [t[0].chartY, t[1] && t[1].chartY], B(u.axes,
                function(a) {
                    if (a.zoomEnabled) {
            ...
            touch: function(n, r) {
                ...
                1 === n.touches.length ? (n = this.normalize(n), (m = u.isInsidePlot(n.chartX - u.plotLeft, n.chartY - u.plotTop)) && !u.openMenu ? (r && this.runPointActions(n), "touchmove" === n.type && (r = this.pinchDown, t = r[0] ? 4 <= Math.sqrt(Math.pow(r[0].chartX - n.chartX, 2) + Math.pow(r[0].chartY - n.chartY, 2)) : !1), h(t, !0) && this.pinch(n)) : r && this.reset()) : 2 === n.touches.length && this.pinch(n)
            },
        ...
        if (!a.hasTouch && (x.PointerEvent || x.MSPointerEvent)) {
            ...
            n(u.prototype, {
                onContainerPointerDown: function(a) {
                    e(a, "onContainerTouchStart", "touchstart",
                    function(a) {
                        m[a.pointerId] = {
                            pageX: a.pageX,
                            pageY: a.pageY,
                ...
                onContainerPointerMove: function(a) {
                    e(a, "onContainerTouchMove", "touchmove",
                    function(a) {
                        m[a.pointerId] = {
                            pageX: a.pageX,
                            pageY: a.pageY
        ...
        a.Legend.prototype = {
            init: function(a, d) {
                this.chart = a;
                this.setOptions(d);
                d.enabled && (this.render(), E(this.chart, "endResize",
                function() {
            ...
            colorizeItem: function(e, d) {
                ...
                m && (n && m.isMarker && (c = e.pointAttribs(), d || a.objectEach(c,
                function(a, b) {
                    c[b] = h
                })), m.attr(c))
            },
            positionItem: function(a) {
                ...
                f = b[0],
                b = b[1],
                g = a.checkbox; (a = a.legendGroup) && a.element && a.translate(d ? f: this.legendWidth - f - 2 * e - 4, b);
                g && (g.x = f, g.y = b)
            },
            ...
            renderItem: function(a) {
                ...
                I || (a.legendGroup = e.g("legend-item").addClass("highcharts-" + z.type + "-series highcharts-color-" + a.colorIndex + (P ? " " + P: "") + (k ? " highcharts-series-" + a.index: "")).attr({
                    zIndex: 1
            ...
            adjustMargins: function(a, d) {
                ...
                b.floating || n([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/],
                function(g, p) {
            ...
            render: function() {
                ...
                b || (a.group = b = f.g("legend").attr({
                    ...
                    zIndex: 1
                }).add(b), a.scrollGroup = f.g().add(a.contentGroup));
                a.renderTitle();
                g = a.getAllItems();
                m(g,
                function(a, c) {
            ...
            handleOverflow: function(a) {
                ...
                g && (e = Math.min(e, g));
                G.length = 0;
                a > e && !1 !== c.enabled ? (this.clipHeight = q = Math.max(e - 20 - this.titleHeight - m, 0), this.currentPage = x(this.currentPage, 1), this.fullHeight = a, n(I,
                function(a, c) {
                    var b = a._legendItemPos[1];
                    a = Math.round(a.legendItem.getBBox().height);
                    var d = G.length;
                    if (!d || b - G[d - 1] > q && (l || b) !== G[d - 1]) G.push(l || b),
                    d++;
                    c === I.length - 1 && b + a - G[d - 1] > q && G.push(b);
                    b !== l && (l = b)
                }), h || (h = d.clipRect = b.clipRect(0, m, 9999, 0), d.contentGroup.clip(h)), k(q), y || (this.nav = y = b.g().attr({
                    zIndex: 1
                }).add(this.group), this.up = b.symbol("triangle", 0, 0, r, r).on("click",
                function() {
                    d.scroll( - 1, w)
                }).add(y), this.pager = b.text("", 15, 10).addClass("highcharts-legend-navigation").css(c.style).add(y), this.down = b.symbol("triangle-down", 0, 0, r, r).on("click",
                function() {
                    d.scroll(1, w)
            ...
            scroll: function(a, d) {
                ...
                }), d = -e[a - 1] + this.initialItemY, this.scrollGroup.animate({
                    translateY: d
        ...
        }; (/Trident\/7\.0/.test(f.navigator.userAgent) || h) && g(a.Legend.prototype, "positionItem",
        function(a, d) {
            var e = this,
            b = function() {
        ...
        e(O.prototype, {
            ...
            initSeries: function(c) {
                var b = this.options.chart; (b = k[c.type || b.type || b.defaultSeriesType]) || a.error(17, !0);
                b = new b;
                b.init(this, c);
                return b
            },
            ...
            redraw: function(c) {
                ...
                this.layOutTitles();
                for (c = l.length; c--;) if (z = l[c], z.options.stacking && (y = !0, z.isDirty)) {
                    m = !0;
                    break
                }
                if (m) for (c = l.length; c--;) z = l[c],
                ...
                p(this, "predraw");
                g(l,
                function(a) { (q || a.isDirty) && a.visible && a.redraw();
                    a.isDirtyData = !1
                });
                d && d.reset(!0);
                h.draw();
            ...
            layOutTitles: function(a) {
                ...
                this.titleOffset = c; ! this.isDirtyBox && b && (this.isDirtyBox = b, this.hasRendered && G(a, !0) && this.isDirtyBox && this.redraw())
            },
            ...
            temporaryDisplay: function(c) {
                var l = this.renderTo;
                if (c) for (; l && l.style;) l.hcOrigStyle && (a.css(l, l.hcOrigStyle), delete l.hcOrigStyle),
                l = l.parentNode;
                else for (; l && l.style;)"none" === b(l, "display", !1) && (l.hcOrigStyle = {
                ...
                l !== this.renderTo && (c.height = 0), a.css(l, c), l.style.setProperty && l.style.setProperty("display", "block", "important")),
                l = l.parentNode
            },
            ...
            reflow: function(a) {
                ...
                if (!k && !c.isPrinting && e && l && (d === N || d === n)) {
                    if (e !== c.containerWidth || l !== c.containerHeight) clearTimeout(c.reflowTimeout),
                    c.reflowTimeout = M(function() {
            ...
            setSize: function(c, b, l) {
                ...
                d.getChartSize();
                c = k.globalAnimation; (c ? B: m)(d.container, {
            ...
            drawChartBox: function() {
                ...
                if (f || d["stroke-width"]) y.stroke = a.borderColor,
                y["stroke-width"] = f;
                ...
                p && (g ? g.animate(I) : this.plotBGImage = c.image(p, q, z, h, w).add());
                v ? v.animate({
                    width: n.width,
                    height: n.height
            ...
            render: function() {
                ...
                if (d || k) g(a,
                function(a) { (a.horiz && d || !a.horiz && k) && a.setTickInterval(!0)
                }),
                this.getMargins();
                this.drawChartBox();
            ...
            isReadyToRender: function() {
                var a = this;
                return Q || N != N.top || "complete" === n.readyState ? !0 : (n.attachEvent("onreadystatechange",
                function() {
        ...
        a.Point.prototype = {
            ...
            optionsToObject: function(a) {
                ...
                else if (u(a)) for (!e && a.length > p && (g = typeof a[0], "string" === g ? f.name = a[0] : "number" === g && (f.x = a[0]), b++); m < p;) e && void 0 === a[b] || (f[d[m]] = a[b]),
                b++,
                m++;
            ...
            destroyElements: function() {
                for (var a = ["graphic", "dataLabel", "dataLabelUpper", "connector", "shadowGroup"], f, g = 6; g--;) f = a[g],
            ...
            firePointEvent: function(a, f, g) {
                var e = this,
                d = this.series.options; (d.point.events[a] || e.options && e.options.events && e.options.events[a]) && this.importEvents();
        ...
        },
        {
            ...
            bindAxes: function() {
                ...
                function(l) {
                    ...
                    function(a) {
                        e = a.options;
                        if (b[l] === e.index || void 0 !== b[l] && b[l] === e.id || void 0 === b[l] && 0 === e.index) c.insert(a.series),
                        c[l] = a,
                        a.isDirty = !0
                    });
            ...
            getCyclic: function(a, c, b) {
                ...
                c || (d = H(e[f], e["_" + f]), x(d) || (l.series.length || (l[g] = 0), e["_" + f] = d = l[g] % y, l[g] += 1), b && (c = b[d]));
                void 0 !== d && (this[f] = d);
                this[a] = c
            },
            getColor: function() {
            ...
            setData: function(c, e, l, f) {
                ...
                q = c.length;
                e = H(e, !0);
                if (!1 !== f && q && y === q && !k.cropped && !k.hasGroupedData && k.visible) t(c,
                function(a, c) {
                    ...
                    if (I && q > I) {
                        for (l = 0; null === w && l < q;) w = c[l],
                        l++;
                        if (p(w)) for (l = 0; l < q; l++) v[l] = this.autoIncrement(),
                        n[l] = c[l];
                        else if (d(w)) if (r) for (l = 0; l < q; l++) w = c[l],
                        v[l] = w[0],
                        n[l] = w.slice(1, r + 1);
                        else for (l = 0; l < q; l++) w = c[l],
                        v[l] = w[0],
                        n[l] = w[1];
                        else a.error(12)
                    } else for (l = 0; l < q; l++) void 0 !== c[l] && (w = {
                        series: k
                    },
            ...
            processData: function(c) {
                ...
                if (w && this.sorted && !m && (!p || e > p || this.forceCrop)) if (b[e - 1] < v || b[0] > n) b = [],
                d = [];
                else if (b[0] < v || b[e - 1] > n) k = this.cropData(this.xData, this.yData, v, n),
                b = k.xData,
                d = k.yData,
                k = k.start,
                f = !0;
                for (p = b.length || 1; --p;) e = h ? q(b[p]) - q(b[p - 1]) : b[p] - b[p - 1],
                0 < e && (void 0 === g || e < g) ? g = e: 0 > e && this.requireSorting && a.error(15);
                this.cropped = f;
                this.cropStart = k;
            ...
            cropData: function(a, c, b, d) {
                ...
                y;
                for (y = 0; y < l; y++) if (a[y] >= b) {
                    e = Math.max(0, y - g);
                    break
                }
                for (b = y; b < l; b++) if (a[b] > d) {
                    f = b + g;
                    break
                }
                return {
            ...
            generatePoints: function() {
                ...
                for (v = 0; v < g; v++) q = p + v,
                m ? (w = (new f).init(this, [k[v]].concat(J(e[v]))), w.dataGroup = this.groupMap[v]) : (w = b[q]) || void 0 === c[q] || (b[q] = w = (new f).init(this, c[q], k[v])),
                w && (w.index = q, h[v] = w);
                this.options.keys = a;
                if (b && (g !== (d = b.length) || m)) for (v = 0; v < d; v++) v !== p || m || (v += g),
            ...
            getExtremes: function(a) {
                ...
                e = a.length;
                for (h = 0; h < e; h++) if (m = b[h], w = a[h], q = (p(w, !0) || d(w)) && (!c.positiveValuesOnly || w.length || 0 < w), m = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (b[h] || m) >= g && (b[h] || m) <= y, q && m) if (q = w.length) for (; q--;) null !== w[q] && (k[f++] = w[q]);
                else k[f++] = w;
                this.dataMin = D(k);
                this.dataMax = F(k)
            },
            ...
            setClip: function(a) {
                ...
                a && !p.count[this.index] && (p.count[this.index] = !0, p.count.length += 1); ! 1 !== b.clip && (this.group.clip(a || e ? p: c.clipRect), this.markerGroup.clip(q), this.sharedClipKey = g);
            ...
            drawPoints: function() {
                ...
                if (!1 !== f.enabled || this._hasPointMarkers) for (d = 0; d < a.length; d++) k = a[d],
                b = k.plotY,
                e = k.graphic,
                g = k.marker || {},
                q = !!k.marker,
                ...
                w = k.isInside,
                m && p(b) && null !== k.y ? (b = H(g.symbol, this.symbol), k.hasImage = 0 === b.indexOf("url"), m = this.markerAttribs(k, k.selected && "select"), e ? e[w ? "show": "hide"](!0).animate(m) : w && (0 < m.width || k.hasImage) && (k.graphic = e = c.renderer.symbol(b, m.x, m.y, m.width, m.height, q ? g: f).add(h)), e && e.attr(this.pointAttribs(k, k.selected && "select")), e && e.addClass(k.getClassName(), !0)) : e && (k.graphic = e.destroy())
            },
            ...
            pointAttribs: function(a, c) {
                ...
                c && (b = b.states[c], c = k.states && k.states[c] || {},
                d = H(c.lineWidth, b.lineWidth, d + H(c.lineWidthPlus, b.lineWidthPlus, 0)), a = c.fillColor || b.fillColor || a, e = c.lineColor || b.lineColor || e);
                return {
                    stroke: e,
                    "stroke-width": d,
                    fill: a
            ...
            destroy: function() {
                ...
                q(a);
                t(a.axisTypes || [],
                function(c) { (w = a[c]) && w.series && (m(w.series, a), w.isDirty = w.forceRedraw = !0)
                });
            ...
            getGraphPath: function(a, c, b) {
                ...
                p = [],
                q;
                a = a || d.points; (f = a.reversed) && a.reverse(); (e = {
                    right: 1,
                    center: 2
                } [e] || e && 3) && f && (e = 4 - e); ! l.connectNulls || c || b || (a = this.getValidPoints(a));
                t(a,
                function(k, f) {
                    var m = k.plotX,
                    w = k.plotY,
                    h = a[f - 1]; (k.leftCliff || h && h.rightCliff) && !b && (q = !0);
                    k.isNull && !x(c) && 0 < f ? q = !l.connectNulls: k.isNull && !c ? q = !0 : (0 === f || q ? f = ["M", k.plotX, k.plotY] : d.getPointSpline ? f = d.getPointSpline(a, k, f) : e ? (f = 1 === e ? ["L", h.plotX, w] : 2 === e ? ["L", (h.plotX + m) / 2, h.plotY, "L", (h.plotX + m) / 2, w] : ["L", m, h.plotY], f.push("L", m, w)) : f = ["L", m, w], p.push(k.x), e && p.push(k.x), g.push.apply(g, f), q = !1)
                });
                g.xMap = p;
            ...
            drawGraph: function() {
                ...
                d = [["graph", "highcharts-graph", c.lineColor || this.color, c.dashStyle]];
                t(this.zones,
                function(b, l) {
            ...
            applyZones: function() {
                ...
                u,
                J = !1;
                d.length && (p || q) && w && void 0 !== w.min && (v = w.reversed, r = w.horiz, p && p.hide(), q && q.hide(), h = w.getExtremes(), t(d,
                function(d, l) {
            ...
            render: function() {
                ...
                a.invertGroups(q); ! 1 === d.clip || a.sharedClipKey || g || b.clip(c.clipRect);
                k && a.animate();
            ...
            buildKDTree: function() {
                function a(b, d, l) {
                    var k, e;
                    if (e = b && b.length) return k = c.kdAxisArray[d % l],
                    b.sort(function(a, c) {
                        return a[k] - c[k]
                    }),
                    e = Math.floor(e / 2),
        ...
        E.prototype = {
            ...
            setOffset: function(a, f) {
                ...
                if (f = this.label) f.align(this.alignOptions, null, d),
                d = f.alignAttr,
                f[!1 === this.options.crop || e.isInsidePlot(d.x, d.y) ? "show": "hide"](!0)
            }
        };
        F.prototype.getStacks = function() {
            ...
            u(a.series,
            function(f) { ! f.options.stacking || !0 !== f.visible && !1 !== a.options.chart.ignoreHiddenSeries || (f.stackKey = f.type + t(f.options.stack, ""))
            })
        };
        ...
        a.prototype.setStackedPoints = function() {
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                ...
                G = (y = q && z < (b ? 0 : p)) ? r: v,
                c[G] || (c[G] = {}),
                c[G][k] || (w[G] && w[G][k] ? (c[G][k] = w[G][k], c[G][k].total = null) : c[G][k] = new E(u, u.options.stackLabels, y, k, h)),
                G = c[G][k],
                null !== z && (G.points[l] = G.points[this.index] = [t(G.cum, b)], n(G.cum) || (G.base = l), G.touched = u.stacksTouched, 0 < K.index && !1 === this.singleStacks && (G.points[l][0] = G.points[this.index + "," + k + ",0"][0])),
                "percent" === d ? (y = y ? v: r, q && c[y] && c[y][k] ? (y = c[y][k], G.total = y.total = Math.max(y.total, G.total) + Math.abs(z) || 0) : G.total = D(G.total + (Math.abs(z) || 0))) : G.total = D(G.total + (z || 0)),
                G.cum = t(G.cum, b) + (z || 0),
        ...
        a.prototype.setPercentStacks = function() {
            ...
            function(f) {
                for (var b = e.length,
                p, h; b--;) if (p = e[b], d = a.getStackIndicator(d, p, a.index, f), p = (h = g[f] && g[f][p]) && h.points[d.key]) h = h.total ? 100 / h.total: 0,
                p[0] = D(p[0] * h),
                p[1] = D(p[1] * h),
                a.stackedYData[b] = p[1]
            })
        };
        a.prototype.getStackIndicator = function(a, f, g, e) { ! n(a) || a.x !== f || e && a.key !== e ? a = {
                x: f,
                index: 0,
                key: e
            }: a.index++;
        ...
        x(a.Chart.prototype, {
            ...
            update: function(a, e) {
                ...
                if (q) {
                    ...
                    if ("inverted" in q || "polar" in q) c.propFromSeries(),
                    l = !0;
                    "alignTicks" in q && (l = !0);
                    p(q,
                    function(a, b) { - 1 !== m("chart." + b, c.propsRequireUpdateSeries) && (w = !0); - 1 !== m(b, c.propsRequireDirtyBox) && (c.isDirtyBox = !0)
                    });
                ...
                function(b) {
                    a[b] && u(J(a[b]),
                    function(a, d) { (d = h(a.id) && c.get(a.id) || c[b][d]) && d.coll === b && d.update(a, !1)
                    })
                });
                l && u(c.axes,
                function(a) {
        ...
        x(A.prototype, {
            update: function(a, d, e, f) {
                function c() {
                    ...
                    p.isDirty = p.isDirtyData = !0; ! p.fixedBox && p.hasCartesianSeries && (h.isDirtyBox = !0);
                ...
                q, h = p.chart,
                w = p.options;
                d = b(d, !0); ! 1 === f ? c() : l.firePointEvent("update", {
                    options: a
                },
                c)
            },
        ...
        x(v.prototype, {
            addPoint: function(a, d, e, f) {
                ...
                v = q.x;
                w = m.length;
                if (this.requireSorting && v < m[w - 1]) for (h = !0; w && m[w - 1] > v;) w--;
        ...
        },
        {
            ...
            getStackPoints: function() {
                ...
                if (this.options.stacking) {
                    ...
                    function(a, d) {
                        var g = 0,
                        c, q;
                        if (f[a] && !f[a].isNull) h.push(f[a]),
                        B([ - 1, 1],
                        function(g) {
                            var h = 1 === g ? "rightNull": "leftNull",
                            w = 0,
                            l = m[n[d + g]];
                            if (l) for (v = e; 0 <= v && v < p;) c = l.points[v],
                            c || (v === e ? f[a][h] = !0 : b[v] && (q = m[a].points[v]) && (w -= q[1] - q[0])),
                            v += A;
            ...
            getGraphPath: function(a) {
                ...
                J = function(c, f, g) {
                    ...
                    g = q[g + "Cliff"] || 0;
                    var l, w, q = !0;
                    g || h ? (l = (h ? c[0] : c[1]) + g, w = c[0] + g, q = !!h) : !t && a[f] && a[f].isNull && (l = w = v);
                    void 0 !== l && (d.push({
                        plotX: b,
                ...
                for (f = 0; f < a.length; f++) if (g = a[f].isNull, b = D(a[f].rectPlotX, a[f].plotX), q = D(a[f].yBottom, H), !g || u) u || J(f, f - 1, "left"),
                g && !t && u || (d.push(a[f]), e.push({
                    x: f,
                    plotX: b,
                    plotY: q
                })),
            ...
            drawGraph: function() {
                ...
                function(m) {
                    ...
                    g ? (g.endX = h.xMap, g.animate({
                        ...
                        fill: D(m[3], E(m[2]).setOpacity(D(x.fillOpacity, .75)).get()),
                        zIndex: 0
        ...
        },
        {
            ...
            getColumnMetrics: function() {
                ...
                d = g.reversed,
                p, b = {},
                h = 0; ! 1 === f.grouping ? h = 1 : F(a.chart.series,
                function(d) {
                    var c = d.options,
                    f = d.yAxis,
                    g;
            ...
            translate: function() {
                ...
                function(e) {
                    ...
                    l,
                    I = Math.max(g, c) - r;
                    Math.abs(I) < b && b && (I = b, l = !d.reversed && !e.negative || d.reversed && e.negative, r = Math.abs(r - p) > b ? c - b: p - (l ? b: 0));
                    e.barX = h;
                    e.pointWidth = v;
        ...
        },
        {
            ...
            updateTotals: function() {
                ...
                for (a = 0; a < d; a++) p = e[a],
                g += b && !p.visible ? 0 : p.isNull ? 0 : p.y;
                this.total = g;
                for (a = 0; a < d; a++) p = e[a],
            ...
            translate: function(a) {
                ...
                for (r = 0; r < y; r++) {
                    ...
                    t.labelPos = [a[0] + h + Math.cos(v) * t.labelDistance, a[1] + c + Math.sin(v) * t.labelDistance, a[0] + h + Math.cos(v) * b, a[1] + c + Math.sin(v) * b, a[0] + h, a[1] + c, 0 > t.labelDistance ? "center": t.half ? "right": "left", v]
                }
            },
            drawGraph: null,
            drawPoints: function() {
        ...
        },
        {
            ...
            setVisible: function(a, g) {
                ...
                g = u(g, b);
                a !== e.visible && (e.visible = e.options.visible = a = void 0 === a ? !e.visible: a, d.options.data[n(e, d.data)] = e.options, F(["graphic", "dataLabel", "connector", "shadowGroup"],
                function(b) {
        ...
        a.distribute = function(a, f) {
            ...
            function(a) {
                ...
                for (d = a.length; d--;) g = a[d],
                h = (Math.min.apply(0, g.targets) + Math.max.apply(0, g.targets)) / 2,
        ...
        f.prototype.drawDataLabels = function() {
            ...
            u = d.chart.renderer;
            if (b.enabled || d._hasPointLabels) d.dlProcessOptions && d.dlProcessOptions(b),
            c = d.plotGroup("dataLabelsGroup", "data-labels", w && !q ? "hidden": "visible", b.zIndex || 6),
            w && (c.attr({
                opacity: +q
            }), q || E(d, "afterAnimate",
            function() {
            ...
            function(f) {
                ...
                if (q = t(g && g.enabled, m.enabled) && null !== f.y) b = r(m, g),
                p = f.getLabelConfig(),
                n = b.format ? h(b.format, p) : b.formatter.call(p, b),
                y = b.style,
                p = b.rotation,
                y.color = t(b.color, y.color, d.color, "#000000"),
                "contrast" === y.color && (f.contrastColor = u.getContrast(f.color || d.color), y.color = b.inside || 0 > t(f.labelDistance, b.distance) || e.stacking ? f.contrastColor: "#000000"),
        ...
        f.prototype.justifyDataLabel = function(a, e, b, f, g, h) {
            ...
            m = b.y + v;
            0 > m && ("bottom" === c ? e.verticalAlign = "top": e.y = -m, n = !0);
            m = b.y + f.height - v;
        ...
        g.pie && (g.pie.prototype.drawDataLabels = function() {
            ...
            O,
            C = [0, 0, 0, 0];
            d.visible && (h.enabled || d._hasPointLabels) && (D(e,
            function(a) {
            ...
            }), f.prototype.drawDataLabels.apply(d), D(e,
            function(a) {
            ...
            function(e, f) {
                ...
                v = [],
                t;
                if (w) for (d.sortByAngle(e, f - .5), 0 < d.maxLabelDistance && (q = Math.max(0, u - y - d.maxLabelDistance), p = Math.min(u + y + d.maxLabelDistance, g.plotHeight), D(e,
                function(a) {
                    0 < a.labelDistance && a.dataLabel && (a.top = Math.max(0, u - y - a.labelDistance), a.bottom = Math.min(u + y + a.labelDistance, g.plotHeight), t = a.dataLabel.getBBox().height || 21, a.positionsIndex = v.push({
                        target: a.labelPos[1] - a.top + t / 2,
                        size: t,
                        rank: a.y
                    }) - 1)
                }), a.distribute(v, p + t - q)), O = 0; O < w; O++) b = e[O],
                p = b.positionsIndex,
                k = b.labelPos,
                l = b.dataLabel,
                E = !1 === b.visible ? "hidden": "inherit",
                q = k[1],
                v && F(v[p]) ? void 0 === v[p].pos ? E = "hidden": (z = v[p].size, N = b.top + v[p].pos) : N = q,
                delete b.positionIndex,
                M = h.justify ? r[0] + (f ? -1 : 1) * (y + b.labelDistance) : d.getX(N < b.top + 2 || N > b.bottom - 2 ? q: N, f, b),
                l._attr = {
                    visibility: E,
                    align: k[6]
                },
                ...
                I = l.getBBox().width,
                q = null,
                M - I < m ? (q = Math.round(I - M + m), C[3] = Math.max(q, C[3])) : M + I > n - m && (q = Math.round(M + I - n + m), C[1] = Math.max(q, C[1])),
                0 > N - z / 2 ? C[0] = Math.max(Math.round( - N + z / 2), C[0]) : N + z / 2 > c && (C[2] = Math.max(Math.round(N + z / 2 - c), C[2])),
                l.sideOverflow = q
            }), 0 === B(C) || this.verifyDataLabelOverflow(C)) && (this.placeDataLabels(), q && D(this.points,
            function(a) {
                var c;
                w = a.connector;
                if ((l = a.dataLabel) && l._pos && a.visible && 0 < a.labelDistance) {
                    E = l._attr.visibility;
                    if (c = !w) a.connector = w = g.renderer.path().addClass("highcharts-data-label-connector highcharts-color-" + a.colorIndex).add(d.dataLabelsGroup),
                    w.attr({
                        "stroke-width": q,
        ...
        g.pie.prototype.connectorPath = function(a) {
            var d = a.x,
            b = a.y;
            return t(this.options.dataLabels.softConnector, !0) ? ["M", d + ("left" === a[6] ? 5 : -5), b, "C", d, b, 2 * a[2] - a[4], 2 * a[3] - a[5], a[2], a[3], "L", a[4], a[5]] : ["M", d + ("left" === a[6] ? 5 : -5), b, "L", a[2], a[3], "L", a[4], a[5]]
        },
        ...
        g.column && (g.column.prototype.alignDataLabel = function(a, e, b, g, h) {
            ...
            b.verticalAlign = t(b.verticalAlign, d || m ? "middle": c ? "top": "bottom");
        ...
        E.prototype.callbacks.push(function(a) {
            function h() {
                ...
                function(a) {
                    ...
                    r = a.dataLabelCollections || ["dataLabel"]; (n.enabled || a._hasPointLabels) && !n.allowOverlap && a.visible && B(r,
                    function(m) {
                        B(a.points,
                        function(a) {
        ...
        E.prototype.hideOverlappingLabels = function(a) {
            ...
            for (r = 0; r < h; r++) if (n = a[r]) n.oldOpacity = n.opacity,
            n.newOpacity = 1;
            a.sort(function(a, d) {
                return (d.labelrank || 0) - (a.labelrank || 0)
            });
            for (r = 0; r < h; r++) for (x = a[r], n = r + 1; n < h; ++n) if (t = a[n], x && t && x !== t && x.placed && t.placed && 0 !== x.newOpacity && 0 !== t.newOpacity && (m = x.alignAttr, f = t.alignAttr, g = x.parentGroup, e = t.parentGroup, d = 2 * (x.box ? 0 : x.padding), m = p(m.x + g.translateX, m.y + g.translateY, x.width - d, x.height - d, f.x + e.translateX, f.y + e.translateY, t.width - d, t.height - d)))(x.labelrank < t.labelrank ? x: t).newOpacity = 0;
            B(a,
            function(a) {
                var b, d;
        ...
        H = a.TrackerMixin = {
            ...
            drawTrackerGraph: function() {
                ...
                n = "rgba(192,192,192," + (v ? .0001 : .002) + ")";
                if (e && !c) for (p = e + 1; p--;)"M" === d[p] && d.splice(p + 1, 0, d[p + 1] - h, d[p + 2], "L"),
                (p && "M" === d[p] || p === e) && d.splice(p, 0, "L", d[p - 2] + h, d[p - 1]);
                k ? k.attr({
                    d: d
        ...
        r(B.prototype, {
            ...
            zoom: function(a) {
                ...
                e = !1,
                g; ! a || a.resetSelection ? u(this.axes,
                function(a) {
                    b = a.zoom()
                }) : u(a.xAxis.concat(a.yAxis),
                function(a) {
                    var d = a.axis;
            ...
            pan: function(a, b) {
                ...
                function(b) {
                    ...
                    q = h - p;
                    0 < q && (h = p, f -= q);
                    b.series.length && f !== g.min && h !== g.max && (b.setExtremes(f, h, !1, !1, {
                        trigger: "pan"
                    }), e = !0);
                    c[d] = l
                });
        ...
        r(p.prototype, {
            ...
            setState: function(a, b) {
                ...
                if (! (a === this.state && !b || this.selected && "select" !== a || !1 === g.enabled || a && (k || l && !1 === q.enabled) || a && n.states && n.states[a] && !1 === n.states[a].enabled)) {
                    ...
                    u && this.graphic.animate(u, d(v.options.chart.animation, q.animation, p.animation)),
                    m && m.hide();
                    else {
                        if (a && q) {
                            p = n.symbol || f.symbol;
        ...
        r(b.prototype, {
            ...
            setState: function(a) {
                ...
                }), b.state = a, !f[a] || !1 !== f[a].enabled) && (a && (g = f[a].lineWidth || g + (f[a].lineWidthPlus || 0)), e && !e.dashstyle)) for (g = {
                    "stroke-width": g
                },
                e.animate(g, d(b.chart.options.chart.animation, f[a] && f[a].animation)); b["zone-graph-" + c];) b["zone-graph-" + c].attr(g),
                c += 1
            },
        ...
        E.prototype.currentOptions = function(h) {
            function r(h, f, g, e) {
                ...
                a.objectEach(h,
                function(a, b) {
                    if (!e && -1 < F(b, ["series", "xAxis", "yAxis"])) for (h[b] = u(h[b]), g[b] = [], d = 0; d < h[b].length; d++) f[b][d] && (g[b][d] = {},
                    r(a[d], f[b][d], g[b][d], e + 1));
                    else n(a) ? (g[b] = D(a) ? [] : {},
                    r(a, f[b] || {},
                    g[b], e + 1)) : g[b] = f[b] || null
                })
            }
            var t = {};
        ...
        t = a.timeUnits,
        m = a.wrap;
        m(a.Series.prototype, "init",
        function(a) {
            var f;
            a.apply(this, Array.prototype.slice.call(arguments, 1)); (f = this.xAxis) && f.options.ordinal && E(this, "updatedData",
            function() {
                delete f.ordinalIndex
            })
        });
        m(B.prototype, "getTimeTicks",
        function(a, g, e, d, p, b, m, v) {
            var f = 0,
            q, r, c = {},
            w, u, y, x = [],
            l = -Number.MAX_VALUE,
            ...
            if (v && h(I)) {
                ...
                w < .6 * I && (w = null);
                v = x[a - 1] > d ? a - 1 : a;
                for (k = void 0; v--;) f = q[v],
                d = Math.abs(k - f),
                k && d < .8 * I && (null === w || d < .8 * w) ? (c[x[v]] && !c[x[v + 1]] ? (d = v + 1, k = f) : d = v, x.splice(d, 1)) : k = f
            }
            return x
        });
        r(B.prototype, {
        ...
        function(a, g) {
            ...
            if (e.options.ordinal && e.series.length) {
                ...
                t = e.val2lin,
                y;
                w.ordinalPositions ? 1 < Math.abs(b) && (r && u(r,
                function(a) {
                    a.setState()
                }), 0 > b ? (r = w, y = e.ordinalPositions ? e: w) : (r = e.ordinalPositions ? e: w, y = w), w = y.ordinalPositions, m > w[w.length - 1] && w.push(m), this.fixedRange = q - n, b = e.toFixedRange(null, null, c.apply(r, [t.apply(r, [n, !0]) + b, !0]), c.apply(y, [t.apply(y, [q, !0]) + b, !0])), b.min >= Math.min(h.dataMin, n) && b.max <= Math.max(m, q) && e.setExtremes(b.min, b.max, !0, !1, {
                    trigger: "pan"
        ...
        D(x.prototype, "setTickPositions",
        function(a) {
        ...
        function(a, f, g) {
            ...
            e.isBroken && (e.val2lin = function(a) {
                var d = a,
                b, f;
                for (f = 0; f < e.breakArray.length; f++) if (b = e.breakArray[f], b.to <= a) d -= b.len;
            ...
            e.lin2val = function(a) {
                var d, b;
                for (b = 0; b < e.breakArray.length && !(d = e.breakArray[b], d.from >= a); b++) d.to < a ? a += d.len: e.isInBreak(d, a) && (a += d.len);
                return a
            },
        ...
        function(a) {
            ...
            m;
            if (f && g && (f.options.breaks || g.options.breaks)) for (; h--;) d = e[h],
            m = null === d.y && !1 === b,
            m || !f.isInAnyBreak(d.x, !0) && !g.isInAnyBreak(d.y, !0) || (e.splice(h, 1), this.data[h] && this.data[h].destroyElements())
        });
        ...
        a.Series.prototype.gappedPath = function() {
            ...
            f = this.points.slice(),
            g = f.length - 1;
            if (a && 0 < g) for (; g--;) f[g + 1].x - f[g].x > this.closestPointRange * a && f.splice(g + 1, 0, {
                isNull: !0
            });
        ...
        e(f.prototype, "update",
        function(c) {
            this.dataGroup ? a.error(24) : c.apply(this, [].slice.call(arguments, 1))
        });
        e(g.prototype, "tooltipFooterHeaderFormatter",
        function(c, b, d) {
            var e = b.series,
            f = e.tooltipOptions,
            ...
            k, h = e.xAxis,
            p = a.dateFormat;
            return h && "datetime" === h.options.type && l && x(b.key) ? (c = e.currentDataGrouping, l = l.dateTimeLabelFormats, c ? (h = l[c.unitName], 1 === c.count ? g = h[0] : (g = h[1], k = h[2])) : !g && l && (g = this.getXDateFormat(b, f, h)), g = p(g, b.key), k && (g += p(k, b.key + c.totalRange - 1)), r(f[(d ? "footer": "header") + "Format"], {
                point: u(b.point, {
                    key: g
                }),
                series: e
        ...
        F.prototype.setDataGrouping = function(a, b) {
            ...
            if (this instanceof F) for (c = this.series.length; c--;) this.series[c].update({
                dataGrouping: a
            },
            !1);
            else h(this.chart.options.series,
            function(c) {
                c.dataGrouping = a
            },
            !1);
        ...
        },
        {
            ...
            translate: function() {
                ...
                E(a.points,
                function(n) {
                    E([n.open, n.high, n.low, n.close, n.low],
                    function(t, m) {
            ...
            drawPoints: function() {
                ...
                function(n) {
                    ...
                    g, e = !f;
                    void 0 !== n.plotY && (f || (n.graphic = f = h.renderer.path().add(a.group)), f.attr(a.pointAttribs(n, n.selected && "select")), u = f.strokeWidth() % 2 / 2, g = Math.round(n.plotX) - u, t = Math.round(n.shapeArgs.width / 2), m = ["M", g, Math.round(n.yBottom), "L", g, Math.round(n.plotHigh)], null !== n.open && (r = Math.round(n.plotOpen) + u, m.push("M", g, r, "L", g - t, r)), null !== n.close && (r = Math.round(n.plotClose) + u, m.push("M", g, r, "L", g + t, r)), f[e ? "attr": "animate"]({
                        d: m
        ...
        D("candlestick", "ohlc", F(E.column, {
            ...
            drawPoints: function() {
                ...
                function(h) {
                    var r = h.graphic,
                    t, m, f, g, e, d, p, b = !r;
                    void 0 !== h.plotY && (r || (h.graphic = r = n.renderer.path().add(a.group)), r.attr(a.pointAttribs(h, h.selected && "select")).shadow(a.options.shadow), e = r.strokeWidth() % 2 / 2, d = Math.round(h.plotX) - e, t = h.plotOpen, m = h.plotClose, f = Math.min(t, m), t = Math.max(t, m), p = Math.round(h.shapeArgs.width / 2), m = Math.round(f) !== Math.round(h.plotHigh), g = t !== h.yBottom, f = Math.round(f) + e, t = Math.round(t) + e, e = [], e.push("M", d - p, t, "L", d - p, f, "L", d + p, f, "L", d + p, t, "Z", "M", d, f, "L", d, m ? Math.round(h.plotHigh) : f, "M", d, t, "L", d, g ? Math.round(h.yBottom) : t), r[b ? "attr": "animate"]({
                        d: e
        ...
        },
        {
            ...
            translate: function() {
                ...
                y,
                G;
                if (h && h.visible && r) for (w = (h.pointXOffset || 0) + (h.barW || 0) / 2, h = h.currentDataGrouping, y = v[r - 1].x + (h ? h.totalRange: 0), m(e,
                function(a, c) {
                    return a.x - c.x
                ...
                function(a, d) {
                    ...
                    a.plotX += w; (b = e[d - 1]) && b.plotX === a.plotX && (void 0 === b.stackIndex && (b.stackIndex = 0), f = b.stackIndex + 1);
                    a.stackIndex = f
                })
            },
            drawPoints: function() {
                ...
                for (r = f.length; r--;) q = f[r],
                u = q.plotX > this.xAxis.len,
                d = q.plotX,
                t = q.stackIndex,
                n = q.options.shape || b.shape,
                h = q.plotY,
                void 0 !== h && (h = q.plotY + m - (void 0 !== t && t * b.stackDistance)),
                c = t ? void 0 : q.plotX,
                w = t ? void 0 : q.plotY,
                t = q.graphic,
                void 0 !== h && 0 <= d && !u ? (t || (t = q.graphic = e.label("", null, null, n, null, null, b.useHTML).attr(this.pointAttribs(q)).css(F(b.style, q.style)).attr({
                ...
                b.useHTML && a.wrap(this.markerGroup, "on",
                function(c) {
        ...
        n === x && B(["flag", "circlepin", "squarepin"],
        function(a) {
        ...
        E.prototype = {
            ...
            render: function() {
                ...
                this.scrollbarRifles = a.path(b(["M", -3, e / 4, "L", -3, 2 * e / 3, "M", 0, e / 4, "L", 0, 2 * e / 3, "M", 3, e / 4, "L", 3, 2 * e / 3], d.vertical)).addClass("highcharts-scrollbar-rifles").add(this.scrollbarGroup);
                this.scrollbar.attr({
            ...
            setRange: function(a, b) {
                ...
                h(f) && (a = Math.max(a, 0), g = Math.ceil(f * a), this.calculatedWidth = m = D(f * Math.min(b, 1) - g), m < c && (g = (f - c + m) * a, m = c), c = Math.floor(g + this.xOffset + this.yOffset), f = m / 2 - .5, this.from = a, this.to = b, e ? (this.scrollbarGroup[n]({
                    ...
                    translateY: f
                }), this.scrollbarTop = c, this.scrollbarLeft = 0) : (this.scrollbarGroup[n]({
                    translateX: c
                }), this.scrollbar[n]({
                    width: m
                }), this.scrollbarRifles[n]({
            ...
            initEvents: function() {
                ...
                a.mouseMoveHandler = function(b) {
                    ...
                    c = a.initPositions; ! a.grabbedCenter || b.touches && 0 === b.touches[0][e] || (d = a.cursorToScrollbarPosition(d)[e], e = a[e], e = d - e, a.hasDragged = !0, a.updatePosition(c[0] + e, c[1] + e), a.hasDragged && t(a, "changed", {
                        from: a.from,
                        to: a.to,
                        trigger: "scrollbar",
                        DOMType: b.type,
            ...
            destroy: function() {
                ...
                this.removeEvents();
                x(["track", "scrollbarRifles", "scrollbar", "scrollbarGroup", "group"],
                function(a) {
        ...
        function(a) {
            ...
            b.options.scrollbar && b.options.scrollbar.enabled && (b.options.scrollbar.vertical = !b.horiz, b.options.startOnTick = b.options.endOnTick = !1, b.scrollbar = new E(b.chart.renderer, b.options.scrollbar, b.chart), B(b.scrollbar, "changed",
            function(a) {
                var d = Math.min(e(b.options.min, b.min), b.min, b.dataMin),
                c = Math.max(e(b.options.max, b.max), b.max, b.dataMax) - d,
                f;
                b.horiz && !b.reversed || !b.horiz && b.reversed ? (f = d + c * this.to, d += c * this.from) : (f = d + c * (1 - this.from), d += c * (1 - this.to));
        ...
        function(a) {
            ...
            a.apply(this, Array.prototype.slice.call(arguments, 1));
            if (f) {
                this.horiz ? (f.position(this.left, this.top + this.height + 2 + this.chart.scrollbarsOffsets[1] + (this.opposite ? 0 : c + this.axisTitleMargin + this.offset), this.width, this.height), c = 1) : (f.position(this.left + this.width + 2 + this.chart.scrollbarsOffsets[0] + (this.opposite ? c + this.axisTitleMargin + this.offset: 0), this.top, this.width, this.height), c = 0);
        ...
        E.prototype = {
            ...
            drawOutline: function(a, b, c, d) {
                ...
                m = this.left - g,
                n = this.top;
                c ? (m -= l, c = n + b + f, b = n + a + f, a = ["M", m + k, n - g - f, "L", m + k, c, "L", m, c, "L", m, b, "L", m + k, b, "L", m + k, n + h + g].concat(e ? ["M", m + k, c - l, "L", m + k, b + l] : [])) : (a += m + g - f, b += m + g - f, n += l, a = ["M", m, n, "L", a, n, "L", a, n + k, "L", b, n + k, "L", b, n, "L", m + h + 2 * g, n].concat(e ? ["M", a - l, n, "L", b + l, n] : []));
                this.outline[d]({
                    d: a
                })
            },
            ...
            render: function(a, b, c, d) {
                ...
                if (!this.hasDragged || u(c)) {
                    ...
                    a = h.toValue(c, !0);
                    b = h.toValue(d, !0);
                    if (Math.abs(b - a) < r) if (this.grabbedLeft) c = h.toPixels(b - r, !0);
                    ...
                    this.scrollbar && (l ? (l = this.top - k, f = this.left - k + (m || !f.opposite ? 0 : (f.titleOffset || 0) + f.axisTitleMargin), k = g + 2 * k) : (l = this.top + (m ? this.height: -k), f = this.left - k), this.scrollbar.position(f, l, e, k), this.scrollbar.setRange(this.zoomedMin / g, this.zoomedMax / g));
                    this.rendered = !0
                }
            },
            ...
            shadesMousedown: function(a, b) {
                ...
                1 === b ? (this.grabbedCenter = h, this.fixedWidth = g, this.dragOffset = h - e) : (a = h - f - g / 2, 0 === b ? a = Math.max(0, a) : 2 === b && a + g >= l && (a = l - g, m = this.getUnionExtremes().dataMax), a !== e && (this.fixedWidth = g, b = d.toFixedRange(a, a + g, null, m), c.xAxis[0].setExtremes(Math.min(b.min, b.max), Math.max(b.min, b.max), !0, null, {
                    trigger: "navigator"
                })))
            },
            ...
            removeEvents: function() {
                this.eventsToUnbind && (t(this.eventsToUnbind,
                function(a) {
                    a()
            ...
            removeBaseSeriesEvents: function() {
                ...
                this.navigatorEnabled && a[0] && !1 !== this.navigatorOptions.adaptToUpdatedData && (t(a,
                function(a) {
            ...
            init: function(a) {
                ...
                a.inverted ? {
                    ...
                    height: b
                })), e || c.series.data ? g.addBaseSeries() : 0 === a.series.length && w(a, "redraw",
                function(b, c) {
                    0 < a.series.length && !g.series && (g.setBaseSeries(), a.redraw = b);
                    b.call(a, c)
                }), g.renderElements(), g.addMouseEvents()) : g.xAxis = {
                ...
                a.options.scrollbar.enabled && (a.scrollbar = g.scrollbar = new q(a.renderer, A(a.options.scrollbar, {
                    ...
                    vertical: a.inverted
                }), a), B(g.scrollbar, "changed",
                function(b) {
                    var c = g.size,
                    d = c * this.to,
                    c = c * this.from;
                    g.hasDragged = g.scrollbar.hasDragged;
                    g.render(0, 0, c, d); (a.options.scrollbar.liveRedraw || "mousemove" !== b.DOMType) && setTimeout(function() {
                        g.onMouseUp(b)
                    })
                }));
            ...
            setBaseSeries: function(a) {
                ...
                this.series && (this.removeBaseSeriesEvents(), t(this.series,
                function(a) {
                    a.destroy()
                }));
                c = this.baseSeries = [];
            ...
            addBaseSeriesEvents: function() {
                var a = this,
                b = a.baseSeries || [];
                b[0] && b[0].xAxis && B(b[0].xAxis, "foundExtremes", this.modifyBaseAxisExtremes); ! 1 !== this.navigatorOptions.adaptToUpdatedData && t(b,
                function(b) {
            ...
            destroy: function() {
                ...
                t("series xAxis yAxis shades outline scrollbarTrack scrollbarRifles scrollbarGroup scrollbar navigatorGroup rendered".split(" "),
                function(a) {
        ...
        E.prototype = {
            clickButton: function(a, d) {
                ...
                if (null !== k && null !== n) {
                    ...
                    else if (m) p = Math.max(r - m, k),
                    r = Math.min(p + m, n);
                    else if ("ytd" === t) if (h) void 0 === n && (k = Number.MAX_VALUE, n = Number.MIN_VALUE, g(e.series,
                    function(a) {
                        a = a.xData;
                        k = Math.min(a[0], k);
                    ...
                    }) : (u = q(e.options.xAxis)[0], A = u.range, u.range = m, C = u.min, u.min = w, B(e, "load",
                    function() {
                        u.range = A;
                        u.min = C
                    }))
            ...
            drawInput: function(a) {
                function c() {
                    ...
                    k = g.dataMin,
                    g = g.dataMax;
                    c !== q.previousValue && (q.previousValue = c, b(c) || (c = a.split("-"), c = Date.UTC(H(c[0]), H(c[1]) - 1, H(c[2]))), b(c) && (x || (c += 6E4 * (new Date).getTimezoneOffset()), p ? c > d.maxInput.HCTime ? c = void 0 : c < k && (c = k) : c < d.minInput.HCTime ? c = void 0 : c > g && (c = g), void 0 !== c && e.setExtremes(p ? c: e.min, p ? e.max: c, void 0, void 0, {
                ...
                u.offset += t.width + 5;
                this[a + "DateBox"] = l = l.label("", u.offset).addClass("highcharts-range-input").attr({
                    padding: 2,
            ...
            render: function(a, b) {
                ...
                E = c.group,
                F = c.rendered; ! 1 !== n.enabled && (F || (c.group = E = f.g("range-selector-buttons").add(), c.zoomText = f.text(m.rangeSelectorZoom, v(w.x, A), 15).css(n.labelStyle).add(E), B = v(w.x, A) + c.zoomText.getBBox().width + 5, g(c.buttonOptions,
                function(a, b) {
                    p[b] = f.button(a.text, B, 0,
                    function() {
                        c.clickButton(b);
                        c.isActive = !0
                    },
                    ...
                    height: 0,
                    zIndex: 1
                }), l.parentNode.insertBefore(q, l), c.inputGroup = q = f.g("input-group").add(), q.offset = 0, c.drawInput("min"), c.drawInput("max"))), c.updateButtonStates(), E[F ? "animate": "attr"]({
        ...
        D.prototype.callbacks.push(function(a) {
            ...
            f, g;
            e && (g = B(a.xAxis[0], "afterSetExtremes",
            function(a) {
        ...
        J(F.prototype, "autoLabelAlign",
        function(a) {
            var b = this.chart,
            c = this.options,
            b = b._labelPanes = b._labelPanes || {},
            d = this.options.labels;
            return this.chart.options.isStock && "yAxis" === this.coll && (c = c.top + "," + c.height, !b[c] && d.enabled) ? (15 === d.x && (d.x = 0), void 0 === d.align && (d.align = "right"), b[c] = this, "right") : a.call(this, [].slice.call(arguments, 1))
        });
        J(F.prototype, "destroy",
        function(a) {
            var b = this.chart,
        ...
        J(F.prototype, "getPlotLinePath",
        function(b, c, e, k, p, q) {
            var l = this,
            ...
            D = function(a) {
                ...
                a = l.options[b];
                return m(a) ? [u[b][a]] : f(a) ? [u.get(a)] : g(r,
                function(a) {
                    return a[b]
                })
            } (l.coll);
            h(l.isXAxis ? u.yAxis: u.xAxis,
            function(a) {
        ...
        F.prototype.getPlotBandPath = function(a, b) {
            ...
            var c = [],
            d;
            if (a && b) if (a.toString() === b.toString()) c = a,
            c.flat = !0;
            else for (d = 0; d < a.length; d += 6) c.push("M", a[d + 1], a[d + 2], "L", a[d + 4], a[d + 5], b[d + 4], b[d + 5], b[d + 1], b[d + 2], "z");
            else c = null;
            return c
        };
        ...
        J(F.prototype, "hideCrosshair",
        function(a, b) {
            a.call(this, b);
            this.crossLabel && (this.crossLabel = this.crossLabel.hide())
        });
        J(F.prototype, "drawCrosshair",
        function(a, b, c) {
            var e, f;
            a.call(this, b, c);
        ...
        c.processData = function() {
            ...
            if (this.xAxis && this.processedYData) for (c = this.processedXData, d = this.processedYData, e = d.length, this.pointArrayMap && (b = t("close", this.pointArrayMap), -1 === b && (b = t(this.pointValKey || "y", this.pointArrayMap))), a = 0; a < e - 1; a++) if (f = d[a] && -1 < b ? d[a][b] : d[a], m(f) && c[a + 1] >= this.xAxis.min && 0 !== f) {
                this.compareValue = f;
                break
            }
        };
        ...
        J(D.prototype, "getSelectedPoints",
        function(a) {
            var b = a.call(this);
            h(this.series,
            function(a) {
                a.hasGroupedData && (b = b.concat(x(a.points || [],
                function(a) {
                    return a.selected
                })))
            });
        ...
        J(D.prototype, "update",
        function(a, b) {
            "scrollbar" in b && this.navigator && (e(!0, this.options.scrollbar, b.scrollbar), this.navigator.update({},
            !1), delete b.scrollbar);
